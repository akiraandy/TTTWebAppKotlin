...
internal class TTTEngineParserTest {
    ...
    private val invalidBoard: GameData = GameData(arrayListOf("X", "X", "X", "O", "O", "O"), null)
    ...
    internal fun computerTurnReturnsNewBoard() {
        ...
        val newBoard = tttEngineParser.generateBoard(computerMakeMove.board, computerMakeMove.move)
        assertEquals(expected, newBoard)
    }
    ...
    internal fun computerMoveReturnsSameBoardIfGameIsOver() {
        ...
        val newBoard = tttEngineParser.generateBoard(computerFullBoard.board, computerFullBoard.move)
        assertEquals(expected, newBoard)
    }
